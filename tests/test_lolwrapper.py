...
class TestLoLWrapper:
    ...
    def test_summoner_champion_mastery_list(self, wrapper, environment):
    ...
    def test_summoner_champion_mastery(self, wrapper, environment):
    ...
    def test_summoner_mastery_score(self, wrapper, environment):
    ...
    def test_champion_rotations(self, wrapper):
    ...
    def test_league_entries_page(self, wrapper):
        ...
        response_page2 = wrapper.league_entries(queue,
                                                tier,
                                                division,
                                                page)
    ...
    def test_league_entries_wrong_parameter_message(self, wrapper):
        """Test an API call to get league entries by page."""
    ...
    def test_match_list(self, wrapper, environment):
    ...
    def test_match_list_with_parameters(self, wrapper, environment):
    ...
    def test_match_list_begin_greater_than_end(self, wrapper, environment):
        ...
        assert "endIndex must be greater than beginIndex" in str(
                                                index_info.value)
        ...
        assert "endTime must be greater than beginTime." in str(
                                                time_info.value)

    def test_match_list_max_range_index_and_time(self, wrapper, environment):
        """
        ...
        assert "The maximum index range allowed is 100." in str(
                                                index_info.value)
        ...
        assert "The maximum time range allowed is one week" in str(
                                                    time_info.value)
    ...
    def test_spectator_featured_games(self, wrapper):
    ...
    def test_summoner_active_game(self, wrapper, environment):
